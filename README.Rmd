...
Columnsdefined using `~` instead of `=` will be evaluated as an anonymous 
...
most suitable data type. On occasion, it may be necessary to specify the data
...
or named list as the local environment. Below we use `dplyr`'s `starwars` dataset
as an example.
